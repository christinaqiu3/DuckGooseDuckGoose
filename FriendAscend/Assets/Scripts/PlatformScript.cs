...
public class PlatformScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        nextPlatform.transform.position = gameObject.transform.position + gameObject.transform.localScale / 2
            + new Vector3((Random.value-0.5f)*horizontalOffset,(Random.value-0.5f)*verticalOffset, (Random.value - 0.5f)*horizontalOffset);
        ...
        if(nextPlatform.transform.position[1]-transform.position[1]>3)
        {
            ...
            plat.transform.position = nextPlatform.transform.position - nextPlatform.transform.localScale / 2
                + Vector3.up * nextPlatform.transform.localScale.y * 2/3.0f + new Vector3((Random.value - 0.5f) * horizontalOffset/2.0f, (Random.value - 0.5f) * verticalOffset/4.0f, (Random.value - 0.5f) * horizontalOffset/2.0f);
